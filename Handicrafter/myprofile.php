...
$sql="select * from tbl_district d inner join tbl_location l on d.districtid=l.districtid inner join tbl_handicraft h on h.locationid=l.locationid where loginid=$handicrafterid";
...
<img src="../Admin/uploads/<?php echo $display["photo"]; ?>" alt/>
<!-- </a> -->

<h1><?php echo $display["handicraftername"];?></h1>
...
<li><a href="editprofile.php?handicrafterid=<?php echo $handicrafterid;?>"> <i class="fa fa-edit"></i> Edit profile</a></li>
</ul>
</div>
</div>
...
<div class="row">
<div class="bio-row">
<p><span>Name </span>:<?php echo $display["handicraftername"];?></p>
</div>
<div class="bio-row">
<p><span>Email </span>: <?php echo $display["email"];?></p>
</div>
<div class="bio-row">
<p><span>Address </span>: <?php echo $display["address"];?></p>
</div>
<div class="bio-row">
...
<div class="bio-row">
<p><span>Contact </span>: <?php echo $display["contact"];?></p>
</div>
<div class="bio-row">
